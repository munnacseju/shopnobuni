...
const Home = ({ addToCart }: HomeProps) => {
    ...
    if (loading) return <div className="container page-section" style={{ textAlign: 'center', fontSize: '1.2rem' }}>Loading Shopno Buni collections...</div>;
                                    ...
                                    return (
                                        <div key={product.id} className="product-card">
                                            <div className="product-img-wrapper">
                                                {hasDiscount && (
                                                    <div className="badge-offer" style={{ top: '1.5rem', right: '1.5rem' }}>
